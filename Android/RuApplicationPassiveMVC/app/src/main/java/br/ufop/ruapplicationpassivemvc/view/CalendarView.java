...
public class CalendarView extends FrameLayout {
    ...
    public void setListeners(OnClickListener onClickListener, SwipeRefreshLayout.OnRefreshListener onRefreshListener,
        ...
        ((SwipeRefreshLayout) findViewById(R.id.calendar_swipe_refresh)).setOnRefreshListener(onRefreshListener);
        RecyclerView mRecyclerView = findViewById(R.id.calendar_recyclerview);
    ...
    public void showLoading() {
        ...
        ((SwipeRefreshLayout) findViewById(R.id.calendar_swipe_refresh)).setRefreshing(true);
    }

    public void showForm() {
        TransitionManager.beginDelayedTransition(this);
        ((SwipeRefreshLayout) findViewById(R.id.calendar_swipe_refresh)).setRefreshing(false);
    }
    ...
    public void clientView() {
        findViewById(R.id.calendar_btn_add).setVisibility(View.GONE);
    }
