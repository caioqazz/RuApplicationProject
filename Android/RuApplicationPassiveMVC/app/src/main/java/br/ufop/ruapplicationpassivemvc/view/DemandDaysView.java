...
public class DemandDaysView extends FrameLayout {
    AlertDialog dialog;

    public DemandDaysView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setListeners(SwipeRefreshLayout.OnRefreshListener onRefreshListener, RecyclerItemClickListener.OnItemClickListener onItemClickListener) {
        ((SwipeRefreshLayout) findViewById(R.id.demand_days_swipe_refresh)).setOnRefreshListener(onRefreshListener);
        RecyclerView mRecyclerView = findViewById(R.id.demand_days_recyclerview);
    ...
    public void showLoading() {
        ...
        ((SwipeRefreshLayout) findViewById(R.id.demand_days_swipe_refresh)).setRefreshing(true);
    }

    public void showForm() {
        TransitionManager.beginDelayedTransition(this);
        ((SwipeRefreshLayout) findViewById(R.id.demand_days_swipe_refresh)).setRefreshing(false);
    }
